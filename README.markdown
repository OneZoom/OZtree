...
;    OneZoom server, set this to `http://images.onezoom.org/`
; * oztree_js_suffix: use `.js` for dev mode or `.min.js` for production
[general]
maintenance_mins = 0
pics_dir = http://images.onezoom.org/
oztree_no_min = 1
