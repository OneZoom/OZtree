{
  ...
  "tour_stop": [
      ...
      },
      {
        ...
        "fly_in_speed": 0.005,
        "update_class": {
            "title": "{{=T('Panning')}}{{if is_testing:}} - GORILLAS{{pass}}",
      ...
      },
      {
        ...
        "fly_in_visibility": "show_self",
        "update_class": {
             "title": "{{=T('Zooming')}}{{if is_testing:}} - PRIMATES{{pass}}",
       ...
       },
       {
            ...
            "update_class": {
                "title": "{{=T('Threat of extinction')}}{{if is_testing:}} - UNCIA{{pass}}",
       ...
       },
       {
            ...
            "update_class": {
                ...
                "title": "{{=T('Search for something')}}{{if is_testing:}} - SEARCHER {{pass}}",
       ...
       },
       {
            ...
            "pos":"max",
            "update_class": {
                "title": "{{=T('Are you lost?')}}{{if is_testing:}} - Cottioidei {{pass}}",
        ...
        },
        {
            ...
            "update_class": {
                ...
                "title": "{{=T('Find common ancestors')}}{{if is_testing:}} - VERTS {{pass}}",
