      ...
      },
      {
       ...
       },
       {
        ...
        },
        {
            ...
            "exec": function() {
                window.onezoom.config.ui.openLinkouts();
                window.onezoom.config.ui.populateLinkouts(
                    {"data":{
        ...
        },
        {
            ...
            "wait": 200,
            "exec": function() {
               window.onezoom.controller.mark_area(window.onezoom.data_repo.ott_id_map[691846]) //animals
               window.onezoom.controller.mark_area(window.onezoom.data_repo.ott_id_map[99252])  //plants
               setTimeout(() => {window.onezoom.controller.clear_all_marked_areas()}, 7000)
            }
       },
        {
            "ott": 99252,
