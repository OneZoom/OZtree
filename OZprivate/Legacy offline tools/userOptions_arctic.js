...
var UserOptions = {
    ...
    'backgroundcolor' : 'rgb(200,215,255)',
...
midnode.prototype.barccolor = function() // branch outline colour logic
{
    ...
    if (colourtype == 4){
        colortoreturn = 'rgba(255,255,255,0.3)';
    }
...
midnode.prototype.traitprecalc = function()
{
	...
	if (this.child1)
	{
        ...
        this.arctic = ((this.child1).arctic) + ((this.child2).arctic);
	...
	else
	{
        ...
        if (metadata.leaf_meta[this.metacode][3] && (metadata.leaf_meta[this.metacode][3] != ""))
        {
            this.arctic = 1;
        }
    }
