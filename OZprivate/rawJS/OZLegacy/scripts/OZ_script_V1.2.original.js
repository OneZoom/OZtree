...
function init2()
{
	if (typeof previous_filename == 'undefined' || previous_filename != file_name 
	    ...
	    if (draft_only)
	    {
	        ...
	        tempscript.src = data_file_path+"/"+file_name+"_min.js";
	    ...
	    else
	    {
	        ...
	        tempscript.src = data_file_path+"/"+file_name+"_tree.js";
	        tempscript.onload = function () {
	            var tempscript2 = document.createElement('script');
	            tempscript2.setAttribute("id", "_meta");
	            tempscript2.src = data_file_path+"/"+file_name+"_meta.js";
...
function init_logos()
{
	...
	if (logo_URL)
    {
    	...
    	$('#logo1').attr('src',home_icon_path); // todo
    	$('#logo1').show();
    } else {
    	$('#logo1').hide();
    }
