...
/**
 * The parts of Midnode a pre_calc / layout / navigation search needs that aren't plain data,
 * so a mock node can be an object literal of only the values the test cares about
 */
const midnode_mock_proto = {};
for (const name of [
  'branch_restart', 'branch_point', 'branch_cubic', 'branch_start', 'branch_end',
  'anchor_area_on_screen',
]) {
