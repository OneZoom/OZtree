...
var drawreminder = false;
	...
	function Resize_only()
	{
        ...
        document.getElementById("headerspace").width = widthres-688;
...
function drawremind()
{
    ...
    function drawopen()
    {
        ...
        context.beginPath();
        context.fillStyle = 'rgba(0,0,0,0.85)';
        context.lineTo( 187, 10 );
        context.lineTo( 167, 10);
        context.lineTo( 177, 0 );
        context.fill();
    ...
    {
        justopened = false;
        window.location.href = "http://www.deepfin.org";
    }
...
function popup_DFsite()
{
    justopened = false;
    drawreminder = false;
    popuptext2 = "Go to DeepFin.org";
    draw2();
}
