...
var drawreminder = false;
	...
	function Resize_only()
	{
        ...
        document.getElementById("headerspace").width = widthres-862;
...
function drawremind()
{
    ...
    function drawopen()
    {
        context.beginPath();
        context.lineWidth = 1;
        context.lineTo( myCanvas.width -174 , 40 );
        context.lineTo( myCanvas.width -174, 10);
        context.lineTo( myCanvas.width -21, 10 );
        context.lineTo( myCanvas.width -21, 40 );
        context.fillStyle = 'rgba(0,0,0,0.85)';
        context.fill();
        context.fillStyle = 'rgb(255,255,255)';
        autotext(false, "Click for a tutorial" , myCanvas.width -98, 25 , 250 , 14);
        ...
        context.beginPath();
        context.fillStyle = 'rgba(0,0,0,0.85)';
        context.lineTo( myCanvas.width -302 -offsetx, 10 );
        context.lineTo( myCanvas.width -282-offsetx, 10);
        context.lineTo( myCanvas.width -292-offsetx, 0 );
        context.fill();
        context.beginPath();
        context.fillStyle = 'rgba(0,0,0,0.85)';
        context.lineTo( myCanvas.width -334-offsetx , 10 );
        context.lineTo( myCanvas.width -314-offsetx, 10);
        context.lineTo( myCanvas.width -324-offsetx, 0 );
        context.fill();
...
{
    justopened = false;
     mywindow = window.open("http://www.marinespecies.org/porifera/index.php");
}

function Link2Portol()
{
    justopened = false;
     mywindow = window.open("https://www.portol.org/");
}
...
function popup_home()
{
    justopened = false;
    drawreminder = false;
    popuptext = "Go to OneZoom Homepage";
    draw2();
}
...
function popup_Dept()
{
    justopened = false;
    drawreminder = false;
    popuptext2 = "Go to World Porifera Database";
    draw2();
}

function popup_Portol()
{
    justopened = false;
    drawreminder = false;
    popuptext2 = "Go to PorTol";
    draw2();
}
