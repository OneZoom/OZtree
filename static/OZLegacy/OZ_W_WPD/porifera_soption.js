...
var backgroundcolor = 'rgb(210,230,250)' //background color 'null' if no background is wanted
...
var commonlabels = false; // makes common names the primary info if false then latin names become the primary focus
