    ...
    def test_all_images_in_db_present_locally(self):
        ...
        if appconfig_contains("url_base=", "images"):
            ...
            for sql in [
                ...
                "SELECT user_preferred_image_src, user_preferred_image_src_id, OTT_ID from `{}`".format('reservations'),
                "SELECT verified_preferred_image_src, verified_preferred_image_src_id, OTT_ID from `{}`".format('reservations')]:
